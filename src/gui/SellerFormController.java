...
public class SellerFormController implements Initializable {
	...
	private Seller getObterDadosFormulario() {
		...
		if (txtEmail.getText() == null || txtEmail.getText().trim().equals("")) {
			exception.adicionarErros("email", "O campo não pode ser vazio");
		}
		obj.setEmail(txtEmail.getText());

		if (dpBirthDate.getValue() == null) {
			exception.adicionarErros("birthDate", "O campo não pode ser vazio");
		} else {
		...
		if (txtBaseSalary.getText() == null || txtBaseSalary.getText().trim().equals("")) {
			exception.adicionarErros("baseSalary", "O campo não pode ser vazio");
		}
	...
	private void setMensagemErro(Map<String, String> erros) {
		...
		labelErrorName.setText((campos.contains("name") ? erros.get("name") : ""));
